...
def mapper():
    ...
    transform_dict = {0: 'Monday', 1: 'Tuesday',2:'Wednesday',3: 'Thursday',
    4: 'Friday',5: 'Saturday',6: 'Sunday'}

    for keys, values in parseInput():
        try:
            pickup_day = datetime.strptime(values[2], "%Y-%m-%d %H:%M:%S").weekday()
        ...
        if pickup_neighborhood != -1:
            ...
            pair = pickup + ',' + transform_dict[pickup_day]
